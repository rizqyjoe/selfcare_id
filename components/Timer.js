  ...
  render() {
    return (
      <View style={styles.container} >
        <ImageBackground style = {styles.headerr} 
      source = {require('../assets/blue.png')}>
        ...
        <Text style={styles.reminder}>Inhale and Exhale for every 5 seconds</Text>
        </View>
        <View style={styles.inputContainer}>
          <Text style={styles.inputLabel}>Breath Mins:</Text>
          <TextInput
